                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach ($orders as $order)
                        <tr>
                            ...
                            <td>{{ $order->price }}</td>
                            <td class="text-end">
                                <a class="btn-danger view" href="{{route('orders.show', $order->id)}}" title="View" data-toggle="tooltip"><i class="material-icons">remove_red_eye</i></a>
                                <a class="btn-danger edit" href="{{route('orders.edit', $order->id)}}" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
